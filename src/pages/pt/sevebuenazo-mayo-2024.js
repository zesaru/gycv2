    ...
    <Layout>
      <main className="contenedor">
        <Content className="p-4">
          ...
          <br />
          <Parrafo>
            1. La finalidad de este concurso es la de incentivar la preparación
            de un potaje o platillo, de cualquier país, utilizando como insumo
            los productos de nuestras marcas corporativas: Peru Chef-f y
            Framidia.
            <br />
            ...
            <br />
            3. Serán 3 ganadores dobles (del participante y de la persona
            agasajada) de canastas con productos de G&amp;C Corporation. <br />
            4. Los menores de edad pueden participar en el concurso bajo
            responsabilidad total de sus padres y/o tutores. <br />
            5. Se recibirá una imagen (foto digital) por participante hasta el
            lunes 15 de mayo, vía correo electrónico. <br />
            6. El resultado del concurso se conocerá el día 19 de mayo del
            presente año y se publicará en los diversos medios de la
            colectividad, así como en la página web de G&amp;C Corporation y
            Facebook institucional <br />
            7. El correo electrónico habilitado para el concurso es
            sevebuenazo@gyc-corp.com <br />
          </Parrafo>
          <br />
          ...
          <Parrafo>
            ...
            digital (tomada de un celular o de una cámara digital). <br />
            ...
            <br />
            <div className="pl-4">
              a) Reseña del plato (ingredientes, preparación y detalles
              culturales y/o regionales del mismo).
              <br />
          ...
          <Parrafo>
            ...
            corporativo del 2025, que será distribuido en diciembre del presente
            ...
            electrónico. <br />
            4. Recibirán (participante y agasajada) sus respectivos premios en
            las direcciones postales que señalaron en los correos electrónicos.{" "}
            <br />
            5. Cualquier cambio del punto anterior (4), los gastos serán
            asumidos por el ganador. <br />
            6. La renuncia al premio no dará ningún derecho de indemnización,
            remuneración y/o compensación económica. <br />
