      ...
      <main className="contenedor">
        <Content>
          ...
          <ContenInner>
            ...
            <br />
            3. 抽選券は、パネトン900ℊの箱のパネトングロリアキャンペーンの表示がされている箇所を切り取ったところのみが使用されます。その抽選券の裏側に参加に必要な内容を記載して下さい。
            <br />
            4. ３に記載部分以外を抽選券とすることはできません。またコピーや不正に作成された抽選券は受け付けられません。
            <br />
            5. 抽選は、2023年02月18日に株式会社G&C CORPORATIONにて行われます。
            <br />
            6. 当選者の名前は、G&C CORPORATIONのホームページ www.gyc-corp.com をはじめとする多くの電子媒体などに掲載される予定です。
            <br />
            7. 抽選の内容は録画され、後日G&C CORPORATIONのホームページとFACEBOOKに掲載される予定です。
            <br />
            8. 抽選券の締め切りは2月15日消印となります。
            <br />
            9. 送付先：
            <br />
            (株) G&amp;C CORPORATION本社 〒511-0001 三重県桑名市上之輪新田1418番地 
            <br />
            (株) G&amp;C CORPORATION美濃加茂営業所 〒505-0052岐阜県美濃加茂市加茂野町今泉1261番地
            ...
            *a）～　f）は、必須事項です。
            ...
            <br />
            d) チケットの出発期限は、2023年３月20日～2023年4月23日の間です。当選者の希望により変更される場合に生じた費用は各当選者の負担となります。
            <br />
            ...
            <br />
            6. 55人分の当選券以外にも５人分の券が引かれ、万が一55人分の券がいずれかが無効になることがある場合、繰り上がりで当選します。
            <br />
            7. 当選者への連絡は抽選日から7日間行われ、もし連絡をとる事ができなかった場合当選は無効となり、６に述べた通り繰り上げ順に当選者が変わります。
